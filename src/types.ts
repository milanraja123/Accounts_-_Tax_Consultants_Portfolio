...
export const translations: Record<Language, TranslationDictionary> = {
  EN: {
    ...
    subtitle: "At Taxwala Associate we are value driven. We offer fair and competitive pricing for all of our services.",
    ...
    featuresTitle: "Consultancy Tax in built",
    ...
    punctualDesc: "Taxwala Associate's goal is customer satisfaction, which we obtain through professionalism and the allocation of ongoing service and support.",
    ...
    supportDesc: "Taxwala Associate offers extra support whenever needed to make sure that our customers businesses succeed in the competitive market.",
    aboutUsHeader: "ABOUT US",
    aboutUsHeadline1: "Building Financial Confidence Through",
    aboutUsHeadline2: "Strategies to blaze your trail",
    aboutUsText1: "We help businesses and individuals navigate taxation, auditing, compliance, and financial planning with accuracy, transparency, and a commitment to long-term success.",
    aboutUsText2: "With a client-focused approach and deep industry expertise, we deliver reliable accounting and advisory services tailored to your unique financial goals. From GST and income tax filing to statutory audits, business registrations, and financial consulting, our mission is to simplify complex financial matters while ensuring complete compliance and sustainable growth.",
    servicesSectionTitle: "Services",
    servicesSectionSub: "COMPETITIVE & COMPREHENSIVE",
    servicesSectionDesc: "At Taxwala Associate we are value driven. We offer fair and competitive pricing for all of our services.",
    servicesSectionAccountingTitle: "Accounting & Business Compliance",
    servicesSectionAccountingDesc: "Taxwala Associate performs accounting and bookkeeping services for small and medium sized businesses in Copenhagen.",
    servicesSectionTaxTitle: "Taxation",
    servicesSectionTaxDesc: "Taxwala Associate has been helping businesses and individuals file their taxes for current and previous years.",
    servicesSectionConsultingTitle: "Consultancy",
    servicesSectionConsultingDesc: "Taxwala Associate consults many businesses and individuals on financial and tax strategy. We have years of experience.",
    seeMore: "See More",
    teamTitle: "Our Team",
    ...
    footerAddressLabel: "Adress : Taxwala Associate, 2750 Ballerup",
    footerTelLabel: "Tel : +45 71469728",
    footerFaxLabel: "Fax : +45 71469728",
    footerEmailLabel: "Email : contact@Taxwala.com",
    whyTitleOverline: "WHY CHOOSE US?",
    whyDavidTitlePart1: "Why Choose ",
    whyDavidTitlePart2: "Taxwala Associate?",
    ...
    whyMilestoneValue: "1k+",
    whyMilestoneLabel: "CLIENTS ACROSS INDIA FOR TAX",
    moneyBackTitle: "100% Money Back Guarantee*",
    moneyBackDesc: "Our client's satisfaction is our #1 priority! That's why each person who avails service with Taxwala Associate is completely protected by our 100% Money Back Guarantee Program*. Simply try our services and if Taxwala Associate does not provide you final legal approved certifications, just checkout our Refund Policy Section.",
    ...
    expertAdviceStat1Value: "1000+",
    expertAdviceStat1Label: "CLIENTS SERVED",
    ...
    testimonial1Quote: "Taxwala Associate helped me file my ITR seamlessly. Their team was professional, responsive, and made the entire process stress-free. Highly recommend their services!",
    testimonial1AuthorName: "Rahul Sharma",
    testimonial1AuthorTitle: "Business Owner, Kolkata",
    ...
    testimonial2AuthorTitle: "Startup Founder, Kolkata",
    testimonial3Quote: "I've been using Taxwala Associate for 3 years now. Their tax planning advice has saved me lakhs. The best accounting firm I've ever worked with!",
    testimonial3AuthorName: "Amit Verma",
    testimonial3AuthorTitle: "IT Professional, Kolkata",
    ...
    growthMarketingConsultingYears: "5 years",
  ...
  DK: {
    ...
    subtitle: "Hos Taxwala Associate er vi værdidrevne. Vi tilbyder rimelige og konkurrencedygtige priser på alle vores ydelser.",
    ...
    punctualDesc: "Taxwala Associates mål er kundetilfredshed, som vi opnår gennem professionalisme og tildeling af løbende service og support.",
    ...
    supportTitle: "Support",
    supportDesc: "Taxwala Associate tilbyder ekstra support, når det er nødvendigt, for at sikre, at kunders virksomheder lykkes på det konkurrenceprægede marked.",
    aboutUsHeader: "OM OS",
    ...
    servicesSectionDesc: "Hos Taxwala Associate er vi værdidrevne. Vi tilbyder rimelige og konkurrencedygtige priser på alle vores ydelser.",
    servicesSectionAccountingTitle: "Regnskab",
    servicesSectionAccountingDesc: "Taxwala Associate udfører regnskabs- og bogføringsydelser for små og mellemstore virksomheder i København.",
    servicesSectionTaxTitle: "Skat",
    servicesSectionTaxDesc: "Taxwala Associate har hjulpet virksomheder og enkeltpersoner med at indberette deres skat for indeværende og tidligere år.",
    servicesSectionConsultingTitle: "Rådgivning",
    servicesSectionConsultingDesc: "Taxwala Associate rådgiver mange virksomheder og enkeltpersoner om finansiel rådgivning og skattestrategi. Vi har mange års erfaring.",
    seeMore: "Se mere",
    ...
    footerAddressLabel: "Adresse : Taxwala Associate, 2750 Ballerup",
    footerTelLabel: "Tlf : +45 71469728",
    footerFaxLabel: "Fax : +45 71469728",
    footerEmailLabel: "E-mail : contact@Taxwala.com",
    ...
    moneyBackDesc: "Vores kunders tilfredshed er vores #1 prioritet! Derfor er hver person, der benytter service hos Taxwala Associate, fuldt beskyttet af vores 100% Pengene Tilbage Garanti Program*. Prøv blot vores tjenester, og hvis Taxwala Associate ikke giver dig endelige juridisk godkendte certificeringer, så tjek vores Refusionspolitik sektion.",
    ...
    testimonial1Quote: "Taxwala Associate hjalp mig med at indberette min ITR problemfrit. Deres team var professionelt, responsivt og gjorde hele processen stressfri. Anbefales varmt!",
    testimonial1AuthorName: "Rahul Sharma",
    ...
    testimonial3Quote: "Jeg har brugt Taxwala Associate i 3 år nu. Deres skatteplanlægningsrådgivning har sparet mig for hundredtusindvis. Det bedste regnskabsfirma, jeg nogensinde har arbejdet med!",
    testimonial3AuthorName: "Amit Verma",
