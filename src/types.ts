...
export const translations: Record<Language, TranslationDictionary> = {
  EN: {
    ...
    subtitle: "At AD Financy we are value driven. We offer fair and competitive pricing for all of our services.",
    ...
    punctualDesc: "AD Financy's goal is customer satisfaction, which we obtain through professionalism and the allocation of ongoing service and support.",
    ...
    supportDesc: "AD Financy offers extra support whenever needed to make sure that our customers businesses succeed in the competitive market.",
    ...
    servicesSectionDesc: "At AD Financy we are value driven. We offer fair and competitive pricing for all of our services.",
    servicesSectionAccountingTitle: "Accounting",
    servicesSectionAccountingDesc: "AD Financy performs accounting and bookkeeping services for small and medium sized businesses in Copenhagen.",
    servicesSectionTaxTitle: "Tax",
    servicesSectionTaxDesc: "AD Financy has been helping businesses and individuals file their taxes for current and previous years.",
    servicesSectionConsultingTitle: "Consulting",
    servicesSectionConsultingDesc: "AD Financy consults many businesses and individuals on financial and tax strategy. We have years of experience.",
    seeMore: "See More",
    teamTitle: "Our Team",
    ...
    footerAddressLabel: "Adress : AD Financy, 2750 Ballerup",
    footerTelLabel: "Tel : +45 71469728",
    footerFaxLabel: "Fax : +45 71469728",
    footerEmailLabel: "Email : Contact@adfinancy.com",
    whyTitleOverline: "WHY CHOOSE ME?",
    whyDavidTitlePart1: "Why Choose ",
    whyDavidTitlePart2: "David?",
    whyDavidSub: "Experience the difference of working with a dedicated professional",
    whyDavidCard1Title: "Certified & Verified CPA",
    whyDavidCard1Desc: "Licensed California CPA with proven expertise and credentials",
    whyDavidCard2Title: "Ethics-Driven Practice",
    whyDavidCard2Desc: "Committed to the highest standards of professional ethics and integrity",
    whyDavidCard3Title: "Personalized Financial Advice",
    whyDavidCard3Desc: "Customized solutions tailored to your unique financial situation",
    whyDavidCard4Title: "California Tax Law Expertise",
    whyDavidCard4Desc: "Deep understanding of both state and federal tax regulations",
  ...
  DK: {
    ...
    subtitle: "Hos AD Financy er vi værdidrevne. Vi tilbyder rimelige og konkurrencedygtige priser på alle vores ydelser.",
    ...
    punctualDesc: "AD Financys mål er kundetilfredshed, som vi opnår gennem professionalisme og tildeling af løbende service og support.",
    ...
    supportTitle: "Support",
    supportDesc: "AD Financy tilbyder ekstra support, når det er nødvendigt, for at sikre, at kunders virksomheder lykkes på det konkurrenceprægede marked.",
    aboutUsHeader: "OM OS",
    ...
    servicesSectionDesc: "Hos AD Financy er vi værdidrevne. Vi tilbyder rimelige og konkurrencedygtige priser på alle vores ydelser.",
    servicesSectionAccountingTitle: "Regnskab",
    servicesSectionAccountingDesc: "AD Financy udfører regnskabs- og bogføringsydelser for små og mellemstore virksomheder i København.",
    servicesSectionTaxTitle: "Skat",
    servicesSectionTaxDesc: "AD Financy har hjulpet virksomheder og enkeltpersoner med at indberette deres skat for indeværende og tidligere år.",
    servicesSectionConsultingTitle: "Rådgivning",
    servicesSectionConsultingDesc: "AD Financy rådgiver mange virksomheder og enkeltpersoner om finansiel rådgivning og skattestrategi. Vi har mange års erfaring.",
    seeMore: "Se mere",
    ...
    footerAddressLabel: "Adresse : AD Financy, 2750 Ballerup",
    footerTelLabel: "Tlf : +45 71469728",
    footerFaxLabel: "Fax : +45 71469728",
    footerEmailLabel: "E-mail : Contact@adfinancy.com",
    whyTitleOverline: "HVORFOR VÆLGE RIGTIGT?",
    whyDavidTitlePart1: "Hvorfor vælge ",
    whyDavidTitlePart2: "David?",
    whyDavidSub: "Oplev forskellen ved at samarbejde med en dedikeret professionel",
    whyDavidCard1Title: "Certificeret & verificeret CPA",
    whyDavidCard1Desc: "Autoriseret CPA med dokumenteret ekspertise og akkreditiver",
    whyDavidCard2Title: "Etikdrevet praksis",
    whyDavidCard2Desc: "Forpligtet til de højeste standarder for professionel etik og integritet",
    whyDavidCard3Title: "Personlig økonomisk rådgivning",
    whyDavidCard3Desc: "Skræddersyede løsninger tilpasset din unikke økonomiske situation",
    whyDavidCard4Title: "Ekspertise i skattelovgivning",
    whyDavidCard4Desc: "Dyb forståelse af både statslige og føderale skatteregler",
